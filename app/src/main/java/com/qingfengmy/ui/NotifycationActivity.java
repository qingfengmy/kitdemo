...
public class NotifycationActivity extends BaseActivity {
    ...
    private void init() {
        ...
        pd = PendingIntent.getActivity(NotifycationActivity.this, 0, intent, 0);
    }
...
//                    baseNF.flags |= Notification.FLAG_INSISTENT;
                    ...
                    //第四个参数：点击该通知时执行页面跳转
                    baseNF.setLatestEventInfo(NotifycationActivity.this, "Title01", "Content01", pd);
                ...
                case R.id.le10bt02:
                    ...
                    baseNF.setLatestEventInfo(NotifycationActivity.this, "Title02", "Content02", pd);
                    nm.notify(Notification_ID_BASE, baseNF);
                    break;
                ...
                case R.id.le10bt04:
                    ...
                    mediaNF.setLatestEventInfo(NotifycationActivity.this, "Title03", "Content03", pd);
                ...
                case R.id.le10bt07:
                    ...
                    RemoteViews contentView = new RemoteViews(getPackageName(), R.layout.layout_notifycation);
