...
public class Movie extends BaseObservable {
    ...
    public static void searchMovies(String  title, final IMovieResponse<List<Movie>> iMovieResponse) {
        ApiClient client = new ApiClient();
        client.getMovieApi().getMovies(title, 0, 50, new Callback<MovieResult>() {
            @Override
            public void success(MovieResult movieResult, Response response) {
                iMovieResponse.onData(movieResult.getSubjects());
            }
